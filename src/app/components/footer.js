...
const centerMap = {
  lat: 30.026129200026432,
  lng: 31.483118512152693,
};
  ...
  return (
    <footer className="text-white py-4 relative">
      <div className={styles.wrapper}>
        <div className="container mx-auto text-center px-[20px] py-[40px] max-w-[1400px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[40px]">
            <div>
              <LoadScript googleMapsApiKey={mapApiKey}>
                <GoogleMap mapContainerStyle={mapContainerStyle} center={centerMap} zoom={14}>
                  <Marker position={centerMap} onClick={() => setShowInfo(true)} />
                  {showInfo && (
                    <InfoWindow position={center} onCloseClick={() => setShowInfo(false)}>
                      <div>
                        <h3>Margins Developments</h3>
                        <p>New Cairo</p>
                      </div>
                    </InfoWindow>
                  )}
            ...
            <div className="text-start">
              <p className="uppercase text-lg font-medium">{t("footer.contactUs")}</p>
              <div className="mt-4 montserrat-font">
                <p className={`${styles["text-with-line"]} text-sm`}>{t("footer.address.title")}</p>
                <p className="capitalize text-base font-medium">{t("footer.address.text")}</p>
              </div>
              <div className="mt-4 montserrat-font">
                <p className={`${styles["text-with-line"]} text-sm`}>{t("footer.phone.title")}</p>
                <p className="capitalize text-lg font-medium">{t("footer.phone.text")}</p>
              </div>
            </div>
            <div className="text-start">
              <h3 className="uppercase text-lg font-medium">{t("footer.followUs")}</h3>
              <div className="grid grid-flow-col gap-1 auto-cols-max py-4">
                <a href="https://www.facebook.com/MarginsDev" target="_blank" rel="noopener noreferrer" className="w-[40px] h-[40px] flex justify-center rounded-sm p-1 border-gray-300 transition-all duration-500 hover:border-gray-100 hover:bg-blue-700">
                ...
                <a href="https://www.instagram.com/margins.developments" target="_blank" rel="noopener noreferrer" className="w-[40px] h-[40px] flex justify-center rounded-sm p-1 border-gray-300 transition-all duration-500 hover:border-gray-100 hover:bg-pink-600">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 71 72" fill="none">
                    <path
                ...
                <a href="https://www.linkedin.com/company/margin-developments/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="w-[40px] h-[40px] flex justify-center rounded-sm p-1 border-gray-300 transition-all duration-500 hover:border-gray-100 hover:bg-blue-900">
                ...
                <a href="https://www.youtube.com/channel/UCV2atjcN8d2c0Q_JkX4_Ydg" target="_blank" rel="noopener noreferrer" className="w-[40px] h-[40px] flex justify-center rounded-sm p-1 border-gray-300 transition-all duration-500 hover:border-gray-100 hover:bg-red-600">
                ...
                <a
                  href="https://www.messenger.com/t/104364141276657/?messaging_source=source%3Apages%3Amessage_shortlink&source_id=1441792&recurring_notification=0"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-[40px] h-[40px] flex justify-center rounded-sm p-1 border-gray-300 transition-all duration-500 hover:border-gray-100 hover:bg-blue-500"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
                    <path
                      fillRule="evenodd"
              ...
              <div className="montserrat-font text-sm mt-4 w-[300px]">
                <span>{t("footer.copyrights.text")}</span>
                <span>{t("footer.copyrights.year")}</span>
                <span>{t("footer.copyrights.company")}</span>
              </div>
              <div className="montserrat-font text-sm mt-4 w-[300px]">
                <span>{t("footer.powerBy.message")}</span>
                <span>{t("footer.powerBy.companyName")}</span>
                <span>{t("footer.powerBy.icon")}</span>
              </div>
            </div>
          </div>
        </div>
